...
import AptechLogo from './Logos/aptech.png';
import MiddlesexLogo from './Logos/middlesex.png';
    ...
    <footer className="bg-neutral-dark text-neutral-light flex flex-col justify-between">
      <div className="container mx-auto flex flex-col lg:flex-row py-6">
        ...
        <div className="flex-1 mb-8 lg:mb-0">
          <h4 className="text-xl font-bold mb-4 text-center lg:text-center">Explore</h4>
